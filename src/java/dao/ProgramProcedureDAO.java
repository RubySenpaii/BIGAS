...
public class ProgramProcedureDAO {
    ...
    public boolean addProgramProcedure(ProgramProcedure programProcedure) {
        try {
            ...
            PreparedStatement ps = conn.prepareStatement("INSERT INTO " + ProgramProcedure.TABLE_NAME + " "
                    ...
                    + ProgramProcedure.COLUMN_PROCEDURE_NO + ", " + ProgramProcedure.COLUMN_PROGRAM_ID + ") "
                    + "VALUES(?, ?, ?, ?)");
            ...
            ps.setInt(4, programProcedure.getProgramID());
    ...
    public ArrayList<ProgramProcedure> getListOfProgramProceduresForProgram(int programID) {
        ArrayList<ProgramProcedure> programProcedures = new ArrayList<>();
        try {
            DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
            Connection conn = myFactory.getConnection();
    ...
    private ArrayList<ProgramProcedure> getDataFromResultSet(ResultSet rs) throws SQLException {
        ...
        while (rs.next()) {
            ...
            programProcedure.setProcedureNo(rs.getInt(ProgramProcedure.COLUMN_PROCEDURE_NO));
            programProcedure.setProgramID(rs.getInt(ProgramProcedure.COLUMN_PROGRAM_ID));
