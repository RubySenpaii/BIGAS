...
<html>
    <head>
        ...
        <title>B.I.G.A.S. System | Technician Assignment - Programs</title>
                    ...
                    <div class>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Assign Technician - Programs</h2>
                                        <div class="clearfix"></div>
                                    </div>
                                    <h3>Assign Technicians for Program: Rat Killing Program</h3>
                                    <br>
                                    <h4>Type: Intervention</h4>
                                    <h4>Description: Eradicate Rat Infestations</h4>
                                    <div class="form-group">
                                        <h4 class="control-label col-md-2 col-sm-2 col-xs-12"># of Team Members:</h4>                                      <div class="col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <div class='clearfix'></div>
                                    <div class="form-group">
                                        <h4 class="control-label col-md-2 col-sm-2 col-xs-12">Team Member #1:</h4>                                      <div class="col-md-3 col-sm-3 col-xs-12">
                                            <select class="form-control">
                                                <option>...</option>
                                                <option>1</option>
                                                <option>2</option>
                                    ...
                                    <div class='clearfix'></div>
                                    <div class="form-group">
                                        <h4 class="control-label col-md-2 col-sm-2 col-xs-12">Team Member #2:</h4>                                      <div class="col-md-3 col-sm-3 col-xs-12">
                                            <select class="form-control">
                                                <option>...</option>
                                                <option>1</option>
                                                <option>2</option>
