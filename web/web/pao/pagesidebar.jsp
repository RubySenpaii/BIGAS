            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                <div class="menu_section">
                    <ul class="nav side-menu">
                        <li><a href="/BIGAS/web/pao/provincestatus.jsp"><i class="fa fa-home"></i> Home Page</a></li>
                        ...
                        <li><a><i class="fa fa-laptop"></i> Programs Monitoring<span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <li><a href="/BIGAS/web/pao/intervention.jsp">Interventions</a></li>
                                <li><a href="/BIGAS/web/pao/provision.jsp">Provisions</a></li>
                                <li><a href="/BIGAS/web/pao/rehabilitation.jsp">Rehabilitation</a></li>
                            </ul>
                        </li>
                        <li><a href="/BIGAS/web/pao/damagemonitoring.jsp"><i class="fa fa-bug"></i> Damage Monitoring</a></li>
                        <li><a><i class="fa fa-database"></i> Data Management <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <li><a href="/BIGAS/web/pao/paoemployee.jsp">PAO Employee</a></li>
                                <!--<li><a href="/BIGAS/web/pages-database/maoemployee.jsp">MAO Employee</a></li>-->
                                <li><a href="farmerlist.jsp">Farmers List</a></li>
                                <li><a href="/BIGAS/web/pao/pestanddiseases.jsp">Pest and Diseases</a></li>
                            </ul>
                        </li>
                ...
                <div class="menu_section">
                    ...
                    <ul class="nav side-menu">
                        <li><a href=""><i class="fa fa-mobile"></i> Create Program</a></li>
